...
base_url = 'https://raw.githubusercontent.com/abhijeetgangan/silicon_data/main/Si_FF/Si_SW_MD/NPT_300K/'
...
data_lammps = pd.read_csv('lammps_npt.dat', sep=r'\s+', header=None)
...
def outer_sim_fn(j, state_nbrs_log_box):
  ...
  state, nbrs, box = lax.fori_loop(
    0, write_every, inner_sim_fn, (state, nbrs, box)
  )

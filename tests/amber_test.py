...
def _charmm_read_params(filename: str) -> tuple[str, ...]:
...
class AMBEREnergyTest(jtu.JAXMDTestCase, parameterized.TestCase):
  @parameterized.product(
    system_info=[
      ...
      # (
      #   "Amber20_Benchmark_Suite/PME/Topologies/FactorIX.prmtop",
      #   "Amber20_Benchmark_Suite/PME/Coordinates/FactorIX.inpcrd",
      #   app.PME,
      # ),  # incompatible with OMM due to negative periodicity
      # (
      #   "Amber20_Benchmark_Suite/PME/Topologies/Cellulose.prmtop",
      #   "Amber20_Benchmark_Suite/PME/Coordinates/Cellulose.inpcrd",
      #   app.PME,
      # ),  # OOM issues
      # (
      #   "Amber20_Benchmark_Suite/PME/Topologies/STMV.prmtop",
      #   "Amber20_Benchmark_Suite/PME/Coordinates/STMV.inpcrd",
      #   app.PME,
      # ),  # OOM issues

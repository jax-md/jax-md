...
class ElasticityTest(test_util.JAXMDTestCase):
  ...
  def test_EMT_from_db_basic(self, spatial_dimension, dtype, low_pressure):
    ...
    for index in range(NUM_SAMPLES):
      ...
      if converged:
        self.assertAllClose(
          cijkl, elasticity._extract_elements(C, False), atol=atol, rtol=rtol
        )
    ...
    for _ in range(NUM_SAMPLES):
      ...
      if spatial_dimension == 2:
        C = jnp.array(
          [
            [
              [[1.13172135, 0.00230386], [0.00230386, 0.55599847]],
              [[0.00230386, 0.39732675], [0.39732675, -0.01848658]],
            ],
            [
              [[0.00230386, 0.39732675], [0.39732675, -0.01848658]],
              [[0.55599847, -0.01848658], [-0.01848658, 1.14191721]],
            ],
          ],
          dtype=dtype,
        )

...
class DynamicsTest(jtu.JaxTestCase):
  ...
  def test_gradient_descent(self, spatial_dimension):
    ...
    for _ in range(STOCHASTIC_SAMPLES):
      ...
      opt_init, opt_apply = minimize.gradient_descent(energy, shift_fn, 1e-1)
  ...
  def test_fire_descent(self, spatial_dimension):
    key = random.PRNGKey(0)

...
[**Quickstart**](#getting-started) | [**Reference docs**](https://jax-md.github.io/jax-md/) | [**Paper**](https://arxiv.org/pdf/1912.04232.pdf) | [**NeurIPS 2020**](https://neurips.cc/virtual/2020/public/poster_83d3d4b6c9579515e1679aca8cbc8033.html)
...
## Spaces ([`space.py`](https://jax-md.github.io/jax-md/reference/space/))
...
- [`space.free()`](https://jax-md.github.io/jax-md/reference/space/) specifies a space with free boundary conditions.
- [`space.periodic(box_size)`](https://jax-md.github.io/jax-md/reference/space/) specifies a space with periodic boundary conditions of side length `box_size`.
- [`space.periodic_general(box)`](https://jax-md.github.io/jax-md/reference/space/) specifies a space as a periodic parellelopiped formed by transforming the unit cube by an affine transformation `box`.
...
## Potential Energy ([`energy.py`](https://jax-md.github.io/jax-md/reference/energy/))
...
- [`energy.soft_sphere`](https://jax-md.github.io/jax-md/reference/energy/) a soft sphere whose energy increases as the overlap of the spheres to some power, `alpha`.
- [`energy.lennard_jones`](https://jax-md.github.io/jax-md/reference/energy/) a standard 12-6 Lennard-Jones potential.
- [`energy.morse`](https://jax-md.github.io/jax-md/reference/energy/) a morse potential.
- [`energy.tersoff`](https://jax-md.github.io/jax-md/reference/energy/) the Tersoff potential for simulating semiconducting materials. Can load parameters from LAMMPS files.
- [`energy.eam`](https://jax-md.github.io/jax-md/reference/energy/) embedded atom model potential with ability to load parameters from LAMMPS files.
- [`energy.stillinger_weber`](https://jax-md.github.io/jax-md/reference/energy/) used to model Silicon-like systems.
- [`energy.bks`](https://jax-md.github.io/jax-md/reference/energy/) Beest-Kramer-van Santen potential used to model silica.
- [`energy.gupta`](https://jax-md.github.io/jax-md/reference/energy/) used to model gold nanoclusters.

We also provide the following neural network potentials:
- [`energy.behler_parrinello`](https://jax-md.github.io/jax-md/reference/energy/) a widely used fixed-feature neural network architecture for molecular systems.
- [`energy.graph_network`](https://jax-md.github.io/jax-md/reference/energy/) a deep graph neural network designed for energy fitting.
...
## Dynamics ([`simulate.py`](https://jax-md.github.io/jax-md/reference/simulate/), [`minimize.py`](https://jax-md.github.io/jax-md/reference/minimize/))
...
- [`simulate.nve`](https://jax-md.github.io/jax-md/reference/simulate/) Constant energy simulation; numerically integrates Newton's laws directly.
- [`simulate.nvt_nose_hoover`](https://jax-md.github.io/jax-md/reference/simulate/) Uses Nose-Hoover chain to simulate a constant temperature system.
- [`simulate.npt_nose_hoover`](https://jax-md.github.io/jax-md/reference/simulate/) Uses Nose-Hoover chain to simulate a system at constant pressure and temperature.
- [`simulate.nvt_langevin`](https://jax-md.github.io/jax-md/reference/simulate/) Simulates a system by numerically integrating the Langevin stochastic differential equation.
- [`simulate.hybrid_swap_mc`](https://jax-md.github.io/jax-md/reference/simulate/) Alternates NVT dynamics with Monte-Carlo swapping moves to generate low energy glasses.
- [`simulate.brownian`](https://jax-md.github.io/jax-md/reference/simulate/) Simulates brownian motion.
- [`minimize.gradient_descent`](https://jax-md.github.io/jax-md/reference/minimize/) Minimizes a system using gradient descent.
- [`minimize.fire_descent`](https://jax-md.github.io/jax-md/reference/minimize/) Minimizes a system using the fast inertial relaxation engine.
...
## Spatial Partitioning ([`partition.py`](https://jax-md.github.io/jax-md/reference/partition/))

In many applications, it is useful to construct spatial partitions of particles / objects in a simulation.

We provide the following methods:
- [`partition.cell_list`](https://jax-md.github.io/jax-md/reference/partition/) Partitions objects (and metadata) into a grid of cells.
- [`partition.neighbor_list`](https://jax-md.github.io/jax-md/reference/partition/) Constructs a set of neighbors within some cutoff distance for each object in a simulation.

...
def calculate_all_angles_and_distances(R, nbr_lists, map_metric, map_disp):
    ...
    filtered_close_idx = jnp.where(nbr_lists.filter2.idx != -1, filtered_close_idx, N)
    ...
    return (close_nbr_dist, far_nbr_dist, body_3_angles, body_4_angles, hb_ang_dist)
...
def body_34_candidate_fn(body_3_inds, nbr_inds, neigh_bo, species, cutoff2, param_mask):
...
def body_4_candidate_fn(body_3_inds, nbr_inds, neigh_bo, species, cutoff2, param_mask):
    """
    ...
    inds, body_4_vals = find_all_4_body_inter(body_3_inds, nbr_inds, neigh_bo, cutoff2)
...
def reaxff_inter_list(
    ...
    filter_hb_fn = filtration(hbond_candidate_fn, lambda x: x > 0.0, is_dense=False)
    ...
    def energy_fn(R, nbr_lists, init_charges=None):
        (close_nbr_dist, far_nbr_dist, body_3_angles, body_4_angles, hb_ang_dist) = (

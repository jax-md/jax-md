...
from jax_md.ff.uma.common.so3 import (
    CoefficientMapping,
    SO3Grid,
...
from jax_md.ff.uma.common.rotation import (
    compute_jacobi_matrices,
    load_jacobi_matrices_from_file,
    init_edge_rot_euler_angles,
    eulers_to_wigner,
)
from jax_md.ff.uma.nn.radial import GaussianSmearing, PolynomialEnvelope
from jax_md.ff.uma.nn.embedding import (
    AtomicEmbedding,
    ChgSpinEmbedding,
    DatasetEmbedding,
    EdgeDegreeEmbedding,

...
class CutoffCoulomb(CoulombHandler):
    ...
    def __init__(self, r_cut: float = 12.0, use_erfc: bool = False, alpha: float = 0.3):
...
class EwaldCoulomb(CoulombHandler):
    ...
    def reciprocal_energy(self, positions: Array, charges: Array, box: Array) -> Array:
    ...
    def self_energy(self, charges: Array) -> Array:
        ...
        return -self.alpha / jnp.sqrt(jnp.pi) * jnp.sum(charges**2) * COULOMB_CONSTANT
    ...
    def real_energy(
        ...
        energy_raw = COULOMB_CONSTANT * qi * qj / r * (erfc_val - (1.0 - factor_coul))
...
class PMECoulomb(CoulombHandler):
    ...
    def __init__(self, grid_size: int = 32, alpha: float = 0.3, r_cut: float = 12.0):
    ...
    def structure_factor(self, charges: Array, positions: Array, box: Array) -> Array:
